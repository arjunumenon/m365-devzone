# YO Teams Generator Bot Bot - `yoTeamsGeneratorBotBot`
...
3. Give the bot a handle (ex: `yoTeamsGeneratorBotBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://botyoteams.azurewebsites.net/api/messages`

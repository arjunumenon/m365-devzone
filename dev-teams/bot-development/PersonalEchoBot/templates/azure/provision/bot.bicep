...
var botServiceSku = contains(provisionParameters, 'botServiceSku') ? provisionParameters['botServiceSku'] : 'S1' // Try to read SKU for Azure Bot Service from parameters
...
resource webApp 'Microsoft.Web/sites@2021-02-01' = {
  ...
  properties: {
    ...
    siteConfig: {
      ...
      linuxFxVersion: 'NODE|14-LTS' // Set NodeJS version to 14.x for your site
    }
  }
  identity: {
    type: 'UserAssigned'

...
export class azureqnaCommandHandler implements TeamsFxBotSsoCommandHandler {
  ...
  async handleCommandReceived(
    ...
    const azQnAResponse : any = await callFunction("getAzureQnAResponse", teamsfx, qnarequestProperties);
